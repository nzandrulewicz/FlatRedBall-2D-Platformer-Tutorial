...
{
    public partial class Door : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Entities.IEntity, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        /// <summary>
        /// The name of the screen to go to when the Player collides with the door.
        /// </summary>
        ...
        public string EditModeType { get; set; } = "Platformer.Entities.Door";
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            {
                throw new System.Exception( "Door has been loaded with a Global content manager, then loaded with a non-global.  This can lead to a lot of bugs");
            }
            #endif
