...
namespace Platformer.Factories
{
    public class DoorFactory : IEntityFactory
    {
        ...
        public static Door CreateNew (float x = 0, float y = 0, float z = 0) 
        {
            return CreateNew(DefaultLayer, x, y, z);
        }
        public static Door CreateNew (Microsoft.Xna.Framework.Vector3 position) 
        {
            return CreateNew(DefaultLayer, position.X, position.Y, position.Z);
        }
        public static Door CreateNew (Microsoft.Xna.Framework.Vector2 position) 
        {
            return CreateNew(DefaultLayer, position.X, position.Y, 0);
        }
        public static Door CreateNew (Layer layer, Microsoft.Xna.Framework.Vector3 position) 
        {
            return CreateNew(layer , position.X, position.Y, position.Z);
        }
        public static Door CreateNew (Layer layer, float x = 0, float y = 0, float z = 0) 
        {
            Door instance = null;
        ...
        public static void RemoveList<T> (System.Collections.Generic.IList<T> listToRemove) where T : Door
        {
        ...
        System.Collections.Generic.List<System.Collections.IList> IEntityFactory.ListsToAddTo => DoorFactory.ListsToAddTo;
