...
{
    public partial class ButtonTabRuntime : Platformer.GumRuntimes.ContainerRuntime, Platformer.GumRuntimes.IButtonBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        Background.CurrentStyleCategoryState = Platformer.GumRuntimes.NineSliceRuntime.StyleCategory.TabBordered;
                        TabText.CurrentColorCategoryState = Platformer.GumRuntimes.TextRuntime.ColorCategory.White;
                        TabText.CurrentStyleCategoryState = Platformer.GumRuntimes.TextRuntime.StyleCategory.Strong;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentButtonCategoryState)
                    {
                        ...
                        case  ButtonCategory.Disabled:
                            ...
                            TabText.CurrentColorCategoryState = Platformer.GumRuntimes.TextRuntime.ColorCategory.Gray;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            Platformer.GumRuntimes.TextRuntime.ColorCategory TabTextCurrentColorCategoryStateFirstValue= Platformer.GumRuntimes.TextRuntime.ColorCategory.Black;
            Platformer.GumRuntimes.TextRuntime.ColorCategory TabTextCurrentColorCategoryStateSecondValue= Platformer.GumRuntimes.TextRuntime.ColorCategory.Black;
            bool setTabTextCurrentStyleCategoryStateFirstValue = false;
            bool setTabTextCurrentStyleCategoryStateSecondValue = false;
            Platformer.GumRuntimes.TextRuntime.StyleCategory TabTextCurrentStyleCategoryStateFirstValue= Platformer.GumRuntimes.TextRuntime.StyleCategory.Tiny;
            Platformer.GumRuntimes.TextRuntime.StyleCategory TabTextCurrentStyleCategoryStateSecondValue= Platformer.GumRuntimes.TextRuntime.StyleCategory.Tiny;
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateFirstValue = Platformer.GumRuntimes.NineSliceRuntime.StyleCategory.TabBordered;
                    ...
                    TabTextCurrentColorCategoryStateFirstValue = Platformer.GumRuntimes.TextRuntime.ColorCategory.White;
                    if (interpolationValue < 1)
                    {
                    ...
                    TabTextCurrentStyleCategoryStateFirstValue = Platformer.GumRuntimes.TextRuntime.StyleCategory.Strong;
                    if (interpolationValue < 1)
                    {
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateSecondValue = Platformer.GumRuntimes.NineSliceRuntime.StyleCategory.TabBordered;
                    ...
                    TabTextCurrentColorCategoryStateSecondValue = Platformer.GumRuntimes.TextRuntime.ColorCategory.White;
                    if (interpolationValue >= 1)
                    {
                        this.TabText.HeightUnits = Gum.DataTypes.DimensionUnitType.RelativeToContainer;
                    }
                    ...
                    TabTextCurrentStyleCategoryStateSecondValue = Platformer.GumRuntimes.TextRuntime.StyleCategory.Strong;
                    if (interpolationValue >= 1)
                    {
                        this.TabText.Text = "Tab 1";
                    }
        ...
        public void InterpolateBetween (ButtonCategory firstState, ButtonCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                ...
                case  ButtonCategory.Disabled:
                    ...
                    setTabTextCurrentColorCategoryStateFirstValue = true;
                    TabTextCurrentColorCategoryStateFirstValue = Platformer.GumRuntimes.TextRuntime.ColorCategory.Gray;
                    break;
                case  ButtonCategory.Highlighted:
                    setBackgroundCurrentColorCategoryStateFirstValue = true;
            ...
            switch(secondState)
            {
                ...
                case  ButtonCategory.Disabled:
                    ...
                    setTabTextCurrentColorCategoryStateSecondValue = true;
                    TabTextCurrentColorCategoryStateSecondValue = Platformer.GumRuntimes.TextRuntime.ColorCategory.Gray;
                    break;
                case  ButtonCategory.Highlighted:
                    setBackgroundCurrentColorCategoryStateSecondValue = true;
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ButtonTabRuntime.VariableState fromState,Platformer.GumRuntimes.Controls.ButtonTabRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ButtonTabRuntime.ButtonCategory fromState,Platformer.GumRuntimes.Controls.ButtonTabRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        public Platformer.GumRuntimes.TextRuntime TabText { get; set; }
        ...
        private void AssignInternalReferences () 
        {
            ...
            TabText = this.GetGraphicalUiElementByName("TabText") as Platformer.GumRuntimes.TextRuntime;
