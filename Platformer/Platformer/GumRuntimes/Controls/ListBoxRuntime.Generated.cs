...
{
    public partial class ListBoxRuntime : Platformer.GumRuntimes.ContainerRuntime, Platformer.GumRuntimes.IListBoxBehavior
    {
        #region State Enums
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ListBoxRuntime.VariableState fromState,Platformer.GumRuntimes.Controls.ListBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ListBoxRuntime.ListBoxCategory fromState,Platformer.GumRuntimes.Controls.ListBoxRuntime.ListBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        Platformer.GumRuntimes.IListBoxBehavior.ListBoxCategory Platformer.GumRuntimes.IListBoxBehavior.CurrentListBoxCategoryState
        {
            set
            {
                switch(value)
                {
                    case  Platformer.GumRuntimes.IListBoxBehavior.ListBoxCategory.Enabled:
                        this.CurrentListBoxCategoryState = ListBoxCategory.Enabled;
                        break;
                    case  Platformer.GumRuntimes.IListBoxBehavior.ListBoxCategory.Disabled:
                        this.CurrentListBoxCategoryState = ListBoxCategory.Disabled;
                        break;
                    case  Platformer.GumRuntimes.IListBoxBehavior.ListBoxCategory.Focused:
                        this.CurrentListBoxCategoryState = ListBoxCategory.Focused;
                        break;
                    case  Platformer.GumRuntimes.IListBoxBehavior.ListBoxCategory.DisabledFocused:
