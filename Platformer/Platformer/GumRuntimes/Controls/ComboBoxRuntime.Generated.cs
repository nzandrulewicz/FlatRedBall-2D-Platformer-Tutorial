...
{
    public partial class ComboBoxRuntime : Platformer.GumRuntimes.ContainerRuntime, Platformer.GumRuntimes.IComboBoxBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        Background.CurrentStyleCategoryState = Platformer.GumRuntimes.NineSliceRuntime.StyleCategory.Solid;
                        ...
                        IconInstance.CurrentIconCategoryState = Platformer.GumRuntimes.Elements.IconRuntime.IconCategory.Arrow2;
                        IconInstance.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentComboBoxCategoryState)
                    {
                        ...
                        case  ComboBoxCategory.Disabled:
                            ...
                            IconInstance.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.Gray;
                            FocusedIndicator.Visible = false;
                            break;
                        case  ComboBoxCategory.Highlighted:
                            TextInstance.CurrentColorCategoryState = Platformer.GumRuntimes.TextRuntime.ColorCategory.PrimaryLight;
                            IconInstance.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryLight;
                            FocusedIndicator.Visible = false;
                            break;
                        case  ComboBoxCategory.Pushed:
                            TextInstance.CurrentColorCategoryState = Platformer.GumRuntimes.TextRuntime.ColorCategory.PrimaryDark;
                            IconInstance.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateFirstValue = Platformer.GumRuntimes.NineSliceRuntime.StyleCategory.Solid;
                    ...
                    IconInstanceCurrentIconCategoryStateFirstValue = Platformer.GumRuntimes.Elements.IconRuntime.IconCategory.Arrow2;
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                    }
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateSecondValue = Platformer.GumRuntimes.NineSliceRuntime.StyleCategory.Solid;
                    ...
                    IconInstanceCurrentIconCategoryStateSecondValue = Platformer.GumRuntimes.Elements.IconRuntime.IconCategory.Arrow2;
                    if (interpolationValue >= 1)
                    {
                        this.IconInstance.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                    }
        ...
        public void InterpolateBetween (ComboBoxCategory firstState, ComboBoxCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                ...
                case  ComboBoxCategory.Disabled:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.Gray;
                    }
                    setTextInstanceCurrentColorCategoryStateFirstValue = true;
                ...
                case  ComboBoxCategory.Highlighted:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryLight;
                    }
                    setTextInstanceCurrentColorCategoryStateFirstValue = true;
                    TextInstanceCurrentColorCategoryStateFirstValue = Platformer.GumRuntimes.TextRuntime.ColorCategory.PrimaryLight;
                    break;
                case  ComboBoxCategory.Pushed:
                    if (interpolationValue < 1)
                    {
                    ...
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                    }
                    setTextInstanceCurrentColorCategoryStateFirstValue = true;
                    TextInstanceCurrentColorCategoryStateFirstValue = Platformer.GumRuntimes.TextRuntime.ColorCategory.PrimaryDark;
                    break;
                case  ComboBoxCategory.HighlightedFocused:
                    if (interpolationValue < 1)
                    {
            ...
            switch(secondState)
            {
                ...
                case  ComboBoxCategory.Highlighted:
                    ...
                    setTextInstanceCurrentColorCategoryStateSecondValue = true;
                    TextInstanceCurrentColorCategoryStateSecondValue = Platformer.GumRuntimes.TextRuntime.ColorCategory.PrimaryLight;
                    break;
                case  ComboBoxCategory.Pushed:
                    if (interpolationValue >= 1)
                    {
                    ...
                    setTextInstanceCurrentColorCategoryStateSecondValue = true;
                    TextInstanceCurrentColorCategoryStateSecondValue = Platformer.GumRuntimes.TextRuntime.ColorCategory.PrimaryDark;
                    break;
                case  ComboBoxCategory.HighlightedFocused:
                    if (interpolationValue >= 1)
                    {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ComboBoxRuntime.VariableState fromState,Platformer.GumRuntimes.Controls.ComboBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ComboBoxRuntime.ComboBoxCategory fromState,Platformer.GumRuntimes.Controls.ComboBoxRuntime.ComboBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        Platformer.GumRuntimes.IComboBoxBehavior.ComboBoxCategory Platformer.GumRuntimes.IComboBoxBehavior.CurrentComboBoxCategoryState
        {
            set
            {
                switch(value)
                {
                    case  Platformer.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Enabled:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Enabled;
                        break;
                    case  Platformer.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Disabled:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Disabled;
                        break;
                    case  Platformer.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Highlighted:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Highlighted;
                        break;
                    case  Platformer.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Pushed:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Pushed;
                        break;
                    case  Platformer.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.HighlightedFocused:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.HighlightedFocused;
                        break;
                    case  Platformer.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Focused:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Focused;
                        break;
                    case  Platformer.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.DisabledFocused:
        ...
        public Platformer.GumRuntimes.Controls.ListBoxRuntime ListBoxInstance { get; set; }
        ...
        private void AssignInternalReferences () 
        {
            ...
            ListBoxInstance = this.GetGraphicalUiElementByName("ListBoxInstance") as Platformer.GumRuntimes.Controls.ListBoxRuntime;
