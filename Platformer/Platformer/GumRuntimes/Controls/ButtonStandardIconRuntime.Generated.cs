...
{
    public partial class ButtonStandardIconRuntime : Platformer.GumRuntimes.ContainerRuntime, Platformer.GumRuntimes.IButtonBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        Icon.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentButtonCategoryState)
                    {
                        ...
                        case  ButtonCategory.Highlighted:
                            ...
                            TextInstance.CurrentColorCategoryState = Platformer.GumRuntimes.TextRuntime.ColorCategory.White;
                            Icon.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.Icon.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                    }
        ...
        public void InterpolateBetween (ButtonCategory firstState, ButtonCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                ...
                case  ButtonCategory.Highlighted:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.Icon.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                    }
                    setTextInstanceCurrentColorCategoryStateFirstValue = true;
                    TextInstanceCurrentColorCategoryStateFirstValue = Platformer.GumRuntimes.TextRuntime.ColorCategory.White;
                    break;
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ButtonStandardIconRuntime.VariableState fromState,Platformer.GumRuntimes.Controls.ButtonStandardIconRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ButtonStandardIconRuntime.ButtonCategory fromState,Platformer.GumRuntimes.Controls.ButtonStandardIconRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
