...
{
    public partial class ButtonCloseRuntime : Platformer.GumRuntimes.ContainerRuntime, Platformer.GumRuntimes.IButtonBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        Background.CurrentColorCategoryState = Platformer.GumRuntimes.NineSliceRuntime.ColorCategory.Danger;
                        Background.CurrentStyleCategoryState = Platformer.GumRuntimes.NineSliceRuntime.StyleCategory.Bordered;
                        Icon.CurrentIconCategoryState = Platformer.GumRuntimes.Elements.IconRuntime.IconCategory.Close;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentButtonCategoryState)
                    {
                        case  ButtonCategory.Enabled:
                            Background.CurrentColorCategoryState = Platformer.GumRuntimes.NineSliceRuntime.ColorCategory.Danger;
                            Icon.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.White;
                            FocusedIndicator.Visible = false;
                            break;
                        case  ButtonCategory.Disabled:
                            ...
                            Icon.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.Gray;
                            FocusedIndicator.Visible = false;
                            break;
                        case  ButtonCategory.Highlighted:
                            Background.CurrentColorCategoryState = Platformer.GumRuntimes.NineSliceRuntime.ColorCategory.Warning;
                            Icon.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.White;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            Platformer.GumRuntimes.Elements.IconRuntime.IconCategory IconCurrentIconCategoryStateFirstValue= Platformer.GumRuntimes.Elements.IconRuntime.IconCategory.None;
            Platformer.GumRuntimes.Elements.IconRuntime.IconCategory IconCurrentIconCategoryStateSecondValue= Platformer.GumRuntimes.Elements.IconRuntime.IconCategory.None;
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentColorCategoryStateFirstValue = Platformer.GumRuntimes.NineSliceRuntime.ColorCategory.Danger;
                    ...
                    IconCurrentIconCategoryStateFirstValue = Platformer.GumRuntimes.Elements.IconRuntime.IconCategory.Close;
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentColorCategoryStateSecondValue = Platformer.GumRuntimes.NineSliceRuntime.ColorCategory.Danger;
                    ...
                    IconCurrentIconCategoryStateSecondValue = Platformer.GumRuntimes.Elements.IconRuntime.IconCategory.Close;
        ...
        public void InterpolateBetween (ButtonCategory firstState, ButtonCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  ButtonCategory.Enabled:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.Icon.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.White;
                    }
                    break;
                case  ButtonCategory.Disabled:
                    setBackgroundCurrentColorCategoryStateFirstValue = true;
                    ...
                    if (interpolationValue < 1)
                    {
                        this.Icon.IconColor = Platformer.GumRuntimes.SpriteRuntime.ColorCategory.Gray;
                    }
                    break;
                case  ButtonCategory.Highlighted:
                    setBackgroundCurrentColorCategoryStateFirstValue = true;
                    BackgroundCurrentColorCategoryStateFirstValue = Platformer.GumRuntimes.NineSliceRuntime.ColorCategory.Warning;
                    if (interpolationValue < 1)
                    {
                        this.FocusedIndicator.Visible = false;
                    }
            ...
            switch(secondState)
            {
                ...
                case  ButtonCategory.Highlighted:
                    setBackgroundCurrentColorCategoryStateSecondValue = true;
                    BackgroundCurrentColorCategoryStateSecondValue = Platformer.GumRuntimes.NineSliceRuntime.ColorCategory.Warning;
                    if (interpolationValue >= 1)
                    {
                        this.FocusedIndicator.Visible = false;
                    }
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ButtonCloseRuntime.VariableState fromState,Platformer.GumRuntimes.Controls.ButtonCloseRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Controls.ButtonCloseRuntime.ButtonCategory fromState,Platformer.GumRuntimes.Controls.ButtonCloseRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        public Platformer.GumRuntimes.Elements.IconRuntime Icon { get; set; }
        ...
        private void AssignInternalReferences () 
        {
            ...
            Icon = this.GetGraphicalUiElementByName("Icon") as Platformer.GumRuntimes.Elements.IconRuntime;
