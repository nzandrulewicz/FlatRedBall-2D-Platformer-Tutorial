...
{
    public partial class VerticalLinesRuntime : Platformer.GumRuntimes.ContainerRuntime
    {
        #region State Enums
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Platformer.GumRuntimes.Elements.VerticalLinesRuntime.VariableState fromState,Platformer.GumRuntimes.Elements.VerticalLinesRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public Platformer.GumRuntimes.SpriteRuntime LinesSprite { get; set; }
        ...
        {
            LinesSprite = this.GetGraphicalUiElementByName("LinesSprite") as Platformer.GumRuntimes.SpriteRuntime;
        }
